...
{{--                   <a class="card-img-top d-block overflow-hidden" href="{{route('show',$produit->id)}}">
 --}}                      <img src="{{ asset('/img/shop/catalog/63.jpg') }}" alt="{{ $produit->nom }}">
                  ...
                  <div class="card-body py-2">
                      <a class="product-meta d-block fs-xs pb-1" href="#">{{ $produit->resume}}</a>
                    <h3 class="product-title fs-sm">
                        <a href="">{{ $produit->nom }}</a>
                    </h3>
                    <div class="d-flex justify-content-between">
                      <div class="product-price">
                          <span class="text-accent">{{ $produit->prix }}</span> FCFA</span>
                      </div>
 ...
 {{--                    <div class="text-center">
     ...
     <div class="col-lg-9">
        {{ $portables->links('vendor.livewire.bootstrap') }}
    </div> 
